  ...
  return (
    <div className="footprint_container">
      ...
      <div className="main-content">
        ...
        <div className="total">
          <p>
            <strong>총 이동 거리:</strong> {totalDistance} km
          </p>
          <p>
            <strong>총 탄소 배출량:</strong> {totalEmissions.toFixed(2)} g CO₂
          </p>
        </div>
      </div>
    </div>
